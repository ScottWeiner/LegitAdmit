...
process.env.STRIPE_KEY = 'sk_test_51LHAWSDQSJEkNxCJyEErNE2vri2HmlZxzkeKNn8m2UKZWPLDSo3m03dMQGRDZieOd0I82PPhOMJjt6qQ8YWLhMRB00S0qffAWf'

let mongo: any

declare global {
    var signin: (id?: string) => string[]; //Don't need to return a promise because we aren't actually going to call the sign up/in services
}
